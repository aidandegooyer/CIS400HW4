...
# Sample 600 data points from one class and 200 from the other for training
...
selected_indices_class_0_relabel = np.random.choice(train_class_0.index, size=num_samples_class_0_relabel, replace=False)
selected_indices_class_1_relabel = np.random.choice(train_class_1.index, size=num_samples_class_1_relabel, replace=False)
...
for i in range(num_experiments):
    ...
    print(f"**********************************************EXPERIMENT NUMBER {i + 1} COMPLETE**********************************************")
...
plt.plot(range(1, epochs + 1), q_train_final, label='Training Data')
plt.plot(range(1, epochs + 1), q_test_final, label='Test Data')
plt.xlabel('Experiment Number')
plt.ylabel('Average q')
plt.title('Average q vs. Experiment Number')
plt.legend()
plt.show()